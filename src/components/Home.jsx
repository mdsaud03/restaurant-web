    ...
    <div className=" min-h-screen flex flex-row justify-between items-center lg:px-32 px-5 bg-[url('./assets/hero.jpg')] bg-cover bg-no-repeat">
      <div className=" w-full lg:-2/3 space-y-5">
        ...
        <p className="text-testColor ">
          ...
          idea was to create an authentic Arabian <br /> Non-Veg restaurant
          specialized in Barbecues, Seafood, Tandoor and lip-smacking kebabs
          with great taste, grand <br /> ambience and unmatched services to
          provide you a memorable dining experience. Arabian Barbecues, Yemani
          Mandi <br /> and Seafood Verities are the unique attractions of the
          menu.The concept of ‘Palmshore' was established in 2008 with <br />
          strong focus and commitment towards quality, exceptional service and
          warm hospitality, employs a team of highly <br /> skilled &
