  ...
  return (
    <div className=" min-h-screen flex flex-col lg:flex-row justify-center items-center lg:px-32 px-5">
      ...
      <div className=" space-y-4 lg:pt-14">
        ...
        <p>
          Arabian Barbecues, Yemani Mandi and Seafood Verities are the unique
          attractions of the menu. The concept of ‘Palmshore' was established in
          2008 with strong focus and commitment towards quality, exceptional
          service and warm hospitality, employs a team of highly skilled &
          experienced chefs and supported by a strong management team different
          levels to ensure it meets the standards.
        </p>

        <p>
          With due emphasis laid on quality, service & hygiene, Palmshore is
